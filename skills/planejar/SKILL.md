...
4. **Padrão do projeto:** seguir o existente (irmão real, `CLAUDE.md` e docs do projeto). Sem padrão → `${CLAUDE_SKILL_DIR}/../../docs/instrucoes/QUALIDADE.md`, dizendo que não há padrão.
