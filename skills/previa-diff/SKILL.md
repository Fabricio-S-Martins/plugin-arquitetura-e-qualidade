...
1. Ler o arquivo e compor a versão nova.
2. Responder com um bloco de código (linguagem do arquivo) só com os trechos alterados e 2-3 linhas de contexto. Mais de um arquivo → nome do arquivo antes de cada bloco.
