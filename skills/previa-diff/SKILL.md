...
2. Responder com um bloco de código (linguagem do arquivo) só com os trechos alterados e 2-3 linhas de contexto. Mais de um arquivo → nome do arquivo antes de cada bloco. 2+ trechos não contíguos no mesmo arquivo → 1 bloco por trecho, na ordem em que aparecem no arquivo; nunca juntar trechos distantes num bloco só. Nada além do bloco: sem comentário depois, salvo se o usuário pedir.
